            ...
            <div class="space-y-4">
                ...
                <div class="grid grid-cols-2 gap-4">
                    <div>
                        ...
                        <input type="text" name="start_year" id="edit-start_year" class="input input-bordered w-full" required>
                    </div>
                    <div>
                        <label class="block text-sm font-medium text-slate-700 mb-1">End Year</label>
                        <input type="text" name="end_year" id="edit-end_year" class="input input-bordered w-full" required>
                    </div>
                </div>
                <div>
