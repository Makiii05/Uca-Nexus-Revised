    ...
    <div class="modal-box max-w-sm">
        <form method="POST" id="delete-form">
            ...
            <div class="text-center">
                ...
                <h3 class="text-lg font-semibold text-slate-800 mb-2">Remove Subject</h3>
                <p class="text-sm text-slate-500 mb-1">Are you sure you want to remove</p>
            ...
            <div class="modal-action justify-center">
                ...
                <button type="submit" class="btn bg-red-600 hover:bg-red-700 text-white border-none">Remove</button>
            </div>
        </form>
    </div>
</dialog>
