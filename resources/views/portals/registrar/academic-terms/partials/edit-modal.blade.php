        ...
        <form method="POST" id="edit-form">
            ...
            <div class="space-y-4">
                ...
                <div>
                    ...
                    <select name="school_year_id" id="edit-school_year_id" class="select select-bordered w-full" required>
                        <option value="">Select school year</option>
                        @foreach($schoolYears as $sy)
                            <option value="{{ $sy->id }}">{{ $sy->code }} - {{ $sy->description }}</option>
                        @endforeach
                    </select>
                </div>
                <div>
                    <label class="block text-sm font-medium text-slate-700 mb-1">Department</label>
                    <select name="department_id" id="edit-department_id" class="select select-bordered w-full">
                ...
                <div class="grid grid-cols-2 gap-4">
                    <div>
                        ...
                        <input type="date" name="start_date" id="edit-start_date" class="input input-bordered w-full" required>
                    </div>
                    <div>
                        <label class="block text-sm font-medium text-slate-700 mb-1">End Date</label>
                        <input type="date" name="end_date" id="edit-end_date" class="input input-bordered w-full" required>
                    </div>
                </div>
            </div>
